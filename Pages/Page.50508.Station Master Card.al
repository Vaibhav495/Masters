...
page 50508 "Station Master Card"
{
    Caption = 'Station Master Card';
    PageType = Card;
    SourceTable = "Station Master";
        ...
        area(navigation)
        {
            group("&Station Master")
            {
                ...
                action("Log")
                {
                    ...
                    RunObject = Page "Station Master Log";
                    RunPageLink = "Station Master" = field("No.");
                ...
                action("Assigned Imprint Method")
                {
                    ApplicationArea = all;
