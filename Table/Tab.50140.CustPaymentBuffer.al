table 50140 "Customer Payment Buffer"
{
    ...
    fields
    {
        ...
        field(170; "Creditor No."; Code[20])
        {
            Caption = 'Creditor No.';
            DataClassification = SystemMetadata;
            // TableRelation = "Cust Ledger Entry"."Creditor No." WHERE("Entry No." = FIELD("Vendor Ledg. Entry No."));
        }
        field(171; "Payment Reference"; Code[50])
        {
            ...
            DataClassification = SystemMetadata;
            Numeric = true;
            // TableRelation = "Cust. Ledger Entry"."Payment Reference" WHERE("Entry No." = FIELD("Vendor Ledg. Entry No."));
        }
        ...
        field(1000; "Remit-to Code"; Code[20])
        {
            ...
            DataClassification = SystemMetadata;
            // TableRelation = "Remit Address".Code WHERE("Customer No." = FIELD("Customer No."));
        }
    }

    keys
    {
        key(Key1; "Customer No.", "Currency Code", "Customer Ledg. Entry No.", "Dimension Entry No.", "Remit-to Code")
        {
            Clustered = true;
        }
    ...
    procedure CopyFieldsFromVendorLedgerEntry(VendorLedgerEntry: Record "Cust. Ledger Entry")
    begin
        ...
        OnCopyFieldsFromCustomerLedgerEntry(VendorLedgerEntry, Rec);
    end;
    ...
    begin
        ...
        OnCopyFieldsToGenJournalLine1(Rec, GenJournalLine);
    end;
    ...
    procedure CopyFieldsFromPaymentBuffer(TempPaymentBuffer: Record "Vendor Payment Buffer")
    begin
    ...
    procedure OnCopyFieldsFromCustomerLedgerEntry(VendorLedgerEntrySource: Record "Cust. Ledger Entry"; var PaymentBufferTarget: Record "Customer Payment Buffer")
    begin
    end;

    [IntegrationEvent(false, false)]
    procedure OnCopyFieldsToGenJournalLine1(PaymentBufferSource: Record "Customer Payment Buffer"; var GenJournalLineTarget: Record "Gen. Journal Line")
    begin
    end;
}