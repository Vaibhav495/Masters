tableextension 50131 PurchInvLine extends "Purch. Inv. Line"
{
    fields
    {
        ...
        field(50062; "BILL TYPE"; Text[100])
        {
            DataClassification = CustomerContent;
        }
        field(50063; "PHONE NO."; Text[30])
        {
            DataClassification = CustomerContent;
        }
        field(50064; "BILL PAID DATE"; Date)
        {
            DataClassification = CustomerContent;
        }
        field(50065; "DAYS OVERDUE"; Integer)
        {
            DataClassification = CustomerContent;
        }
